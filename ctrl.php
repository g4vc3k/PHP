...
getRouter()->addRoute('calcShow',    'CalcCtrl',  ['raz','tydzien','miesiac','rok']);
getRouter()->addRoute('calcCompute', 'CalcCtrl',  ['raz','tydzien','miesiac','rok']);
getRouter()->addRoute('login',       'LoginCtrl');
getRouter()->addRoute('logout',      'LoginCtrl', ['raz','tydzien','miesiac','rok']);
getRouter()->addRoute('chroniona',  'CalcCtrl',    ['rok']);
